        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="/latihan/proses">
              @csrf
              <table class="table datatable">
                ...
                @foreach ($data as $p)
                  <tr>
                    <td><input type="checkbox" name="latihan_id"></td>
                    <td>{{$p -> pertanyaan }}</td>
                  </tr>
                 @endforeach
                </body>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-15">
          <div class="card">
            <div class="card-body">
            <form class=" p-3 p-md-3" action="{{ route('latihan.proses') }}" method="post" enctype="multipart/form-data">
              @csrf
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label"></label>
                  <div class="col-sm-9">
                    @foreach ($data as $d)
                      <input type="checkbox" value="{{ $d->id}}" name="latihan_id[]">
                      <label>{{$d -> pertanyaan }}<br></label>
                    @endforeach
                  </div>
                </div>  
                <div class="row mb-3">
