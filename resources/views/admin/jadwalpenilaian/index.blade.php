    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
            <h6 class="card-title text-center">Halaman Jadwal Pengukuran</h6>
                <!-- TOMBOL TAMBAH DATA -->
                <div class="pb-3">
                  <a href="{{ route('jadwalpenilaian.create') }}" class="btn btn-primary">+ Tambah Data</a>
                </div>
                ...
                <table class="table datatable">
                  ...
                  <a href="{{ route('jadwalpenilaian.edit', $j->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i>
                    Edit</a>
                  <form action="{{ route('jadwalpenilaian.destroy', $j->id) }}" method="POST" class="d-inline">
                  @csrf
                  @method('DELETE')
