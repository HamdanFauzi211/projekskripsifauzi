            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('admin.register.proses') }}">
                  @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="username" name="username" class="form-control" id="yourEmail" required>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Nomor Handphone</label>
