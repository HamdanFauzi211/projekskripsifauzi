    ...
    <div class="container py-5">
        <div class="row justify-content-start">
            <div class="col-lg-12 text-center text-lg-start">
                <h1 class="display-4 mb-md-4 text-center">Halaman Total Grafik</h1>
            </div>
        </div>
    </div>
</div>
...
<script>
        ...
        fetch('/admin/json_grafik')
            ...
            // Mengambil data untuk labels (tanggal jadwal) dan datasets (jumlah interpretasi akhir per kesimpulan)
                ...
                // Mengubah tanggal ke format hari, dd/mm/yyyy menjadi hari, dd/mm/yyyy
                ...
                var barChart = new Chart(ctx, {
                    ...
                    options: {
                        scales: {
                            y: {
                                display: false // Menghilangkan nilai angka pada sumbu y
                            }
                        }
                    }
                });
